...
{% macro create_or_replace_netflix_stage(dry_run=True) %}
    ...
    {% set stage_db     = 'sung_demo' %}
    {% set stage_schema = 'stages' %}
    ...
    {% set create_or_replace_query %}
        ...
        -- create the stage
        -- storage_integration = myint; this piece of config should only be done in the snowflake console as this provides secure access
        -- add this storage_integration config for private files
